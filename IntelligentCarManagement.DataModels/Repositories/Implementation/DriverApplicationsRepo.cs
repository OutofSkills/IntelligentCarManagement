...
{
    internal class DriverApplicationsRepo : Repo<DriverApplication>, IDriverApplicationsRepo
    {
        public DriverApplicationsRepo(CarMngContext _context) : base(_context)
        {
        }
    }
}
