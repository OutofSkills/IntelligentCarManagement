...
namespace Api.DataAccess.Migrations
{
    ...
    [Migration("20220601115142_RideMoneyPrecisionFix")]
    partial class RideMoneyPrecisionFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Ride", b =>
                {
                    ...
                    b.HasIndex("RideReviewId")
                        .IsUnique()
                        .HasFilter("[RideReviewId] IS NOT NULL");
            ...
            modelBuilder.Entity("Models.Notification", b =>
                {
                    b.HasOne("Models.NotificationCategory", "NotificationCategory")
            ...
            modelBuilder.Entity("Models.Ride", b =>
                {
                    ...
                    b.HasOne("Models.Review", "Review")
                        .WithOne("Ride")
                        .HasForeignKey("Models.Ride", "RideReviewId");
